...
</div>`;function Y(){const r=document.querySelector("#smartWatches");r&&(r.innerHTML+=W)}const K=`<div class="page__sale">\r
  <div class="sale">\r
...
</div>`;function J(){const r=document.querySelector("#latest");r&&(r.innerHTML+=V)}E();H();$();O();D();N();F();U();Y();Q();J();new Swiper(".products-section__slider",{loop:!0,grabCursor:!0,pagination:{el:".products-section__swiper-pagination",clickable:!0,renderBullet:function(r,u){return'<button type="button" class="'+u+'"></button>'}}});const z=document.querySelector(".promo-video__icon"),X=document.querySelector(".promo-video__play-video"),k=document.querySelector("iframe");z.addEventListener("click",()=>{X.classList.add("active");const r=new URL(k.src);r.searchParams.set("autoplay","1"),k.src=r.toString()});
