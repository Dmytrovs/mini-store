(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))_(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const g of o.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&_(g)}).observe(document,{childList:!0,subtree:!0});function c(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function _(n){if(n.ep)return;n.ep=!0;const o=c(n);fetch(n.href,o)}})();const A=`<header class="header">\r
...
</header>`;function x(){document.body.style.overflow="hidden"}function q(){document.body.style.overflow="auto"}function P(){document.body.style.overflow==="hidden"?q():x()}function E(){const r=document.querySelector("#header");if(!r)return;r.innerHTML+=A;const d=document.querySelectorAll(".menu__toggle-btn");d.forEach(c=>{c.addEventListener("click",_=>{_.stopPropagation();const n=c.nextElementSibling,o=c.getAttribute("aria-expanded")==="true";c.classList.toggle("open"),c.setAttribute("aria-expanded",!o),n.classList.toggle("open",!o)})}),document.addEventListener("click",()=>{d.forEach(c=>{c.setAttribute("aria-expanded","false"),c.nextElementSibling.classList.remove("open"),c.classList.remove("open")})}),document.querySelector(".icon-menu")&&document.addEventListener("click",function(c){c.target.closest(".icon-menu")&&(P(),document.documentElement.classList.toggle("menu-open"))})}const S=document.querySelector(" .menu__item .menu__toggle-btn ");S&&S.addEventListener("click",r=>{r.target.blur()});const T=`<footer class="footer">\r
...
`;function H(){const r=document.querySelector("#footer");if(!r){console.warn("Елемент footerEl не знайдено");return}r.innerHTML=T;function d(){const _=document.querySelectorAll("[data-spollers]");if(_.length>0){let u=function(l,i=!1){l.forEach(t=>{t=i?t.item:t,i&&i.matches||!i?(t.classList.add("_spoller-init"),v(t)):(t.classList.remove("_spoller-init"),v(t,!1))})},v=function(l,i=!0){let t=l.querySelectorAll("details");t.length&&t.forEach(e=>{let a=e.querySelector("summary");i?(a.removeAttribute("tabindex"),e.hasAttribute("data-open")?(a.classList.add("_spoller-active"),e.open=!0):(e.open=!1,a.nextElementSibling.hidden=!0)):(a.setAttribute("tabindex","-1"),a.classList.remove("_spoller-active"),e.open=!0,a.nextElementSibling.hidden=!1)})},y=function(l){const i=l.target;if(i.closest("summary")&&i.closest("[data-spollers]")&&(l.preventDefault(),i.closest("[data-spollers]").classList.contains("_spoller-init"))){const t=i.closest("summary"),e=t.closest("details"),a=t.closest("[data-spollers]"),m=a.hasAttribute("data-one-spoller"),f=e.hasAttribute("data-spoller-scroll"),h=a.dataset.spollersSpeed?parseInt(a.dataset.spollersSpeed):500;if(!a.querySelectorAll("._slide").length&&(m&&!e.open&&w(a),e.open?setTimeout(()=>{e.open=!1},h):e.open=!0,t.classList.toggle("_spoller-active"),g(t.nextElementSibling,h),f&&t.classList.contains("_spoller-active"))){const b=e.dataset.spollerScroll,L=+b?+b:0,I=e.hasAttribute("data-spoller-scroll-noheader")?document.querySelector(".header").offsetHeight:0;window.scrollTo({top:e.offsetTop-(L+I),behavior:"smooth"})}}if(!i.closest("[data-spollers]")){const t=document.querySelectorAll("[data-spoller-close]");t.length&&t.forEach(e=>{const a=e.closest("[data-spollers]"),m=e.parentNode;if(a.classList.contains("_spoller-init")){const f=a.dataset.spollersSpeed?parseInt(a.dataset.spollersSpeed):500;e.classList.remove("_spoller-active"),n(e.nextElementSibling,f),setTimeout(()=>{m.open=!1},f)}})}},w=function(l){const i=l.querySelector("details[open]");if(i&&!l.querySelectorAll("._slide").length){const t=i.querySelector("summary"),e=l.dataset.spollersSpeed?parseInt(l.dataset.spollersSpeed):500;t.classList.remove("_spoller-active"),n(t.nextElementSibling,e),setTimeout(()=>{i.open=!1},e)}};var ss=u,rs=v,ts=y,es=w;document.addEventListener("click",y);const s=Array.from(_).filter(function(l,i,t){return!l.dataset.spollers.split(",")[0]});s.length&&u(s);const p=Array.from(_).filter(function(l,i,t){return l.dataset.spollers.split(",")[0]});if(p.length>0){const l=[];p.forEach(t=>{const a=t.dataset.spollers.split(","),m={};m.value=a[0],m.type=a[1]?a[1].trim():"max",m.item=t,l.push(m)});const i=l.map(function(t){return"("+t.type+"-width: "+t.value+"px),"+t.value+","+t.type}).filter(function(t,e,a){return a.indexOf(t)===e});i&&i.length&&i.forEach(t=>{const e=t.split(","),a=e[1],m=e[2],f=window.matchMedia(e[0]),h=l.filter(function(b){return b.value===a&&b.type===m});f.addEventListener("change",function(){u(h,f)}),u(h,f)})}}let n=(s,p=500,u=0)=>{s.classList.contains("_slide")||(s.classList.add("_slide"),s.style.transitionProperty="height, margin, padding",s.style.transitionDuration=p+"ms",s.style.height=`${s.offsetHeight}px`,s.offsetHeight,s.style.overflow="hidden",s.style.height=u?`${u}px`:"0px",s.style.paddingTop=0,s.style.paddingBottom=0,s.style.marginTop=0,s.style.marginBottom=0,window.setTimeout(()=>{s.hidden=!u,u||s.style.removeProperty("height"),s.style.removeProperty("padding-top"),s.style.removeProperty("padding-bottom"),s.style.removeProperty("margin-top"),s.style.removeProperty("margin-bottom"),u||s.style.removeProperty("overflow"),s.style.removeProperty("transition-duration"),s.style.removeProperty("transition-property"),s.classList.remove("_slide"),document.dispatchEvent(new CustomEvent("slideUpDone",{detail:{target:s}}))},p))},o=(s,p=500,u=0)=>{if(!s.classList.contains("_slide")){s.classList.add("_slide"),s.hidden=s.hidden?!1:null,u&&s.style.removeProperty("height");let v=s.offsetHeight;s.style.overflow="hidden",s.style.height=u?`${u}px`:"0px",s.style.paddingTop=0,s.style.paddingBottom=0,s.style.marginTop=0,s.style.marginBottom=0,s.offsetHeight,s.style.transitionProperty="height, margin, padding",s.style.transitionDuration=p+"ms",s.style.height=v+"px",s.style.removeProperty("padding-top"),s.style.removeProperty("padding-bottom"),s.style.removeProperty("margin-top"),s.style.removeProperty("margin-bottom"),window.setTimeout(()=>{s.style.removeProperty("height"),s.style.removeProperty("overflow"),s.style.removeProperty("transition-duration"),s.style.removeProperty("transition-property"),s.classList.remove("_slide"),document.dispatchEvent(new CustomEvent("slideDownDone",{detail:{target:s}}))},p)}},g=(s,p=500)=>s.hidden?o(s,p):n(s,p)}d();const c=document.querySelector("[data-spollers]");c&&c.addEventListener("click",_=>{_.target.blur()})}const j=`<div class="page__hero hero">\r
...
</div>`;function O(){const r=document.querySelector("#insta");r&&(r.innerHTML+=M)}const C=`<div class="subscribe">\r
...
</div>`;function B(){const r=document.querySelector("#subscribe");r&&(r.innerHTML+=C)}const D=`<div class="testimonials">\r
...
</div>`;function F(){const r=document.querySelector("#features");r&&(r.innerHTML+=G)}const R=`<div class="mobile-products ">\r
...
</div>`;function U(){const r=document.querySelector("#mobileProducts");r&&(r.innerHTML+=R)}const W=`<div class="smart-watches">\r
...
</div>`;function Y(){const r=document.querySelector("#smartWatches");r&&(r.innerHTML+=W)}const Q=`<div class="page__sale">\r
  <div class="sale">\r
...
</div>-->`;function K(){const r=document.querySelector("#sale");r&&(r.innerHTML+=Q)}const V=`<div class="latest">\r
...
</div>`;function J(){const r=document.querySelector("#latest");r&&(r.innerHTML+=V)}E();H();$();O();B();N();F();U();Y();K();J();Z();new Swiper(".products-section__slider",{loop:!0,grabCursor:!0,pagination:{el:".products-section__swiper-pagination",clickable:!0,renderBullet:function(r,d){return'<button type="button" class="'+d+'"></button>'}}});const z=document.querySelector(".promo-video__icon"),X=document.querySelector(".promo-video__play-video"),k=document.querySelector("iframe");z.addEventListener("click",()=>{X.classList.add("active");const r=new URL(k.src);r.searchParams.set("autoplay","1"),k.src=r.toString()});function Z(){document.querySelectorAll(".quantity").forEach(r=>{const d=r.querySelector(".quantity__input");r.addEventListener("click",c=>{const _=c.target.closest("[data-action]");if(!_)return;const n=_.dataset.action;let o=parseInt(d.value);isNaN(o)&&(o=1),n==="increase"&&(d.value=o+1),n==="decrease"&&(d.value=Math.max(1,o-1))})})}
