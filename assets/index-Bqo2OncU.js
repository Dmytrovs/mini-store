...
\r
`;function M(){const o=document.querySelector("#mainSection");o&&(o.innerHTML+=D,O())}function O(){const o=document.querySelector(".hero__swiper"),u=document.querySelector(".hero__swiper-button--next"),l=document.querySelector(".hero__swiper-button--prev");o&&u&&l&&new Swiper(o,{slidesPerView:1,loop:!0,grabCursor:!0,autoplay:{delay:3e3,disableOnInteraction:!1},navigation:{nextEl:u,prevEl:l}})}q();I();M();
