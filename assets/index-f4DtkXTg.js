...
</div>`;function M(){const t=document.querySelector("#insta");t&&(t.innerHTML+=$)}const C=`<div class="subscribe">\r
...
</div>`;function O(){const t=document.querySelector("#subscribe");t&&(t.innerHTML+=C)}const D=`<div class="testimonials">\r
...
</div>`;function B(){const t=document.querySelector("#testimonials");t&&(t.innerHTML+=D,new Swiper(".testimonials__slider",{loop:!0,slidesPerView:1,grabCursor:!0,autoplay:{delay:3e3,disableOnInteraction:!1,pauseOnMouseEnter:!0},navigation:{nextEl:".testimonials__swiper-button--next",prevEl:".testimonials__swiper-button--prev"}}))}const F=`<div class="features">\r
...
</div>`;function N(){const t=document.querySelector("#features");t&&(t.innerHTML+=F)}const U=`<div class="mobile-products ">\r
